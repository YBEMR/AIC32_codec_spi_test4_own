...
//
//    // 配置上拉电阻
//    GpioCtrlRegs.GPBPUD.bit.GPIO54 = 1;   // 禁用 GPIO54 (SPISIMOA) 上拉
//    GpioCtrlRegs.GPBPUD.bit.GPIO55 = 0;   // 启用 GPIO55 (SPISOMIA) 上拉（输入）
//    GpioCtrlRegs.GPBPUD.bit.GPIO56 = 1;   // 禁用 GPIO56 (SPICLKA) 上拉
//    GpioCtrlRegs.GPBPUD.bit.GPIO57 = 1;   // 禁用 GPIO57 (CS) 上拉
//
//    // 设置异步输入资格
...
//
//    // 配置 SPI 功能引脚
//    GpioCtrlRegs.GPBMUX2.bit.GPIO54 = 1;  // GPIO54 为 SPISIMOA
//    GpioCtrlRegs.GPBMUX2.bit.GPIO55 = 1;  // GPIO55 为 SPISOMIA
//    GpioCtrlRegs.GPBMUX2.bit.GPIO56 = 1;  // GPIO56 为 SPICLKA
//    GpioCtrlRegs.GPBMUX2.bit.GPIO57 = 0;  // GPIO57 为普通 GPIO（手动 CS）
//
//    // 设置 GPIO57 为输出（初始状态）
//    GpioCtrlRegs.GPBDIR.bit.GPIO57 = 1;   // GPIO57 为输出
//
//    EDIS;
//}
